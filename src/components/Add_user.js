    ...
    return(
      <div className="users__form">
        ...
        <form className="form" onChange={(e)=>this.getInput(e, e.target.name)} onSubmit={(e)=>this.addNewUser(e)}>
          <div className="group">
            <input maxLength='40' value={this.state.name} className="group__item" type="text" id="fname" placeholder="First Name" name='name' required/>
          ...
          <div className="group">
            <input maxLength='20' value={this.state.education} className="group__item" type="text" id="edu" placeholder="Education" name="education" required/>
            <label className="group__item__label" htmlFor="edu">Education</label>
          </div>
          <div className="group">
            <input maxLength='20' value={this.state.job} className="group__item" type="text" id="job" placeholder="Job" name="job" required/>
